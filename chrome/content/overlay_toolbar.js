...
function toggleSSH(e) {
  if (/^toolbarbutton$/i.test(e.target.nodeName)) {
    // the main toolbarbutton has been clicked, toggle SSH connexion
...
function initServerList()
{
  ...
  if (mp)  { _removeAllChildren(mp); } // Purge de la liste...
